...
export function buildStorySceneBrief(input: StorySceneInput): string {
  ...
  return (
    ...
    "COMPOSITION: place the product as the hero in the VERTICAL CENTRE of a tall frame; keep the TOP 18% clear and " +
    "simple (reserved for a logo) AND keep the LOWER 42% calm, soft and almost empty (a clean surface, gentle " +
    "shadow or soft fabric) — that bottom space is reserved for a text card and must stay simple and uncluttered.\n\n" +
