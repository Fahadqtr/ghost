...
import LegacyReportsPage from "@/app/(app)/inventory/reports/page";
  ...
  return (
    <div className="space-y-4" dir="rtl">
      <header className="flex flex-wrap items-center gap-2">
        ...
        <h1 className="text-lg font-bold text-slate-900">التقارير</h1>
      </header>
      <LegacyReportsPage searchParams={searchParams} />
    </div>
  );
}
