...
export async function GET(
  ...
  try {
    ...
    const products = (await fetchAll((from, to) =>
      supabase
        .from("products")
        .select("id, sku, barcode, name_en, name_ar, main_category, sub_category, product_type, price, discount_price, image_url, description_en, description_ar, keywords_en, keywords_ar")
