...
const SYSTEM_PROMPT =
  ...
  'وضوح مهم: أدوات تعديل السعر والمخزون والاعتماد وإضافة المنتج متاحة وتعمل فعلًا عبر أدوات الكتابة هذه. ' +
  'ممنوع منعًا باتًا أن تقولي إن أداة التعديل "غير متاحة" أو "تحتاج صلاحيات قاعدة بيانات" أو أن التعديل ' +
  'يتم "يدويًا من لوحة التحكم". هذا الكلام يخص فقط النشر للمنصّات (Meta/TikTok)، وليس تعديل السعر/المخزون/الاعتماد/المنتجات. ' +
